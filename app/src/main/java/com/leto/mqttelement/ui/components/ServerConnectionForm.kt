...
import com.leto.mqttelement.data.model.isValidClientId
import com.leto.mqttelement.data.model.isValidForPublishing
import com.leto.mqttelement.data.model.isValidServerAddress
import com.leto.mqttelement.data.model.isValidWebSocketPath
...
fun ServerConnectionForm(
    ...
    var clientId by remember {
        mutableStateOf(
            ...
            "MQTTElement${System.currentTimeMillis().toString().takeLast(6)}"
        )
    }
